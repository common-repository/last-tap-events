...
class LastTap_Enqueue extends LastTap_BaseController
{
    ...
    wp_enqueue_script('locale_js', $this->plugin_url .'assets/libs/core/locales-all.min.js', array('jquery'), '', true);
    ...
    wp_enqueue_script('list_js', $this->plugin_url .'assets/libs/list/main.js', array('jquery'), '', true);
            ...
            wp_enqueue_script('boostrap-', $this->plugin_url . 'assets/js/bootstrap.js');
    ...
    public function lt_enqueue_public()
    {
        ...
        wp_enqueue_script('particle', $this->plugin_url. 'assets/js/particle.js', array('jquery'), '1.0.0', false);
        wp_enqueue_script( 'countdown', $this->plugin_url . '/js/countdown/jquery.plugin.min.js', array( 'jquery' ), '20181214', true );
        wp_enqueue_script( 'countdown-plugin', $this->plugin_url . '/js/countdown/jquery.countdown.min.js', array( 'jquery' ), '20181214', true );
