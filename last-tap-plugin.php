...
require_once(dirname(__FILE__) . '/inc/MetaBox/EventMetaBox.php');
...
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_CalendarCallbacks.php');

require_once(dirname(__FILE__) . '/inc/controller/LastTap_Calendar.php');  
