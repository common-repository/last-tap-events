...
class LastTap_AdminCallbacks extends LastTap_BaseController
{
    ...
    public function lt_event_header_sanitize_color( $input )
    {
            ...
            if(!isset($input)) {
                return   $value = esc_attr( get_option( 'event_text_header_color' ));
            }
            // Validate Background Color
            $background = trim( $input );
            $background = strip_tags( stripslashes( $background ) );
            ...
            if( false === $this->check_color( $background ) ) {
                ...
                // Get the previous valid value
            $value = esc_attr( get_option( 'event_text_header_color' ));
    ...
    public function lt_event_sanitize_google_key_map( $input )
    {
                $output = get_option('event_google_key_map');
...
public function check_color( $value ) { 
    ...
    public function lt_event_textFields_border($args)
    {
...
public function lt_chanche_header_text_color()
{
        $value = esc_attr( get_option( 'event_text_header_color' ));
        
 echo '<label>
            <input type="text" name="event_text_header_color" value="'.$value.'" class="ch-color-picker">
      </label>';
}
...
public function lt_google_map_key()
{
        $value = esc_attr( get_option( 'event_google_key_map' ));
        // $name = $args['label_for'];
        // $classes = $args['class'];
 ...
 echo '<label>
            <input type="text" name="event_google_key_map" value="'.$value.'" class="input">
      </label>';
}
